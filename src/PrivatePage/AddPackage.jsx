      ...
      <div className="card-body">
        <fieldset className="fieldset text-center font-bold text-[16px] p-4">
          ...
          <div className='flex gap-4'>
                ...
                <input type="text" name='guide-name' className="input" placeholder="guide-name" />
            </div>
          <div className='flex gap-4'>
                <label className="label">Guide Photo</label>
                <input type="text" name='guide-photo' className="input" placeholder="guide-photo" />
            </div>
          <div className='flex gap-4'>
                <label className="label">Guide Email</label>
                <input type="text" name='guide-email' className="input" placeholder="guide-email" />
            </div>
