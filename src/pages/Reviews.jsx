...
const Reviews = () => {
    return (
     ...
     <h2 className="text-3xl font-bold text-center mt-4 pt-6 pb-3 text-sky-800">
    Loved By Explorers Like You</h2>
<p className="text-center text-gray-600 mb-7 w-3/4 mx-auto">Discover what 
our travelers  say about their experiences with us. From breathtaking
 ...
 new journeys. Your adventure could be next!
   ...
   <div className='w-3/4 mb-12 mx-auto flex flex-col justify-center items-center'>
<Slide>
<div className='w-[500px]  mx-auto text-center p-3 rounded-2xl mt-6 mb-6 shadow-2xl bg-gradient-to-br   from-sky-700 to-white'>
     <div>
