...
<Swiper
  ...
  className="lg:w-11/12 w-4/5 mx-auto mt-8 pt-9  pb-5  "
  
> 
 {/* 1 */}
   <SwiperSlide>
    <div  className=' flex flex-col lg:flex-row item-center justify-center bg-center bg-cover pb-4 '></div>
<div className="hero text-white  w-11/12 mx-auto bg-gradient-to-tr from-sky-700 shadow-2xl rounded-2xl to-white-auto p-8">
 ...
 <img 
      ...
      className="max-w-sm p-2 m-2 rounded-lg shadow-2xl"
    />
    </div>
...
<div className="hero text-white  w-11/12 mx-auto bg-gradient-to-tr from-sky-700 shadow-2xl rounded-2xl to-white-auto p-8">
 ...
 <img 
    ...
    <div className='p-6 flex-1'>
      <h1 className="text-4xl font-bold"> Bagerhat (Sixty Dome Mosque)</h1>
      <p className="py-6">
       <span className='font-bold text-lg pr-2'>History:</span> 
...
<div className="hero text-white  w-11/12 mx-auto bg-gradient-to-tr from-sky-700 shadow-2xl rounded-2xl to-white-auto p-8">
 ...
 <img 
    ...
    <div className='p-6 flex-1'>
      <h1 className="text-4xl font-bold">Ratargul Swamp Forest </h1>
      <p className="py-6">
       <span className='font-bold text-lg pr-2'>History:</span> 
